    ...
    {fields.map(field => {
      ...
      return (
        <div key={field.name} className="bg-white border p-4 rounded-lg shadow-sm">
          <h4 className="font-semibold text-indigo-700 mb-2">{field.name}</h4>
  ...
  return (
    <div className="bg-white border p-4 rounded-lg shadow-sm">
      <div className="flex justify-between items-center mb-2">
        <h4 className="font-semibold text-indigo-700">Correlation Analysis</h4>
...
export function StatsSummary({ fields, correlationThreshold: initialThreshold = 0.5 }: StatsSummaryProps) {
  ...
  return (
    <div className="bg-gray-50 p-6 rounded-2xl shadow space-y-8 max-w-5xl mx-auto">
      <h2 className="text-2xl font-bold text-indigo-700 mb-2">Statistical Analysis Dashboard</h2>
